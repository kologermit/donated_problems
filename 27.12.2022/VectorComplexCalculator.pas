...
function moduleVectorComplex(a: VectorComplex): real;
...
function moduleVectorComplex(a: VectorComplex): real;
begin
	moduleVectorComplex := sqrt(moduleComplex(a.x)*moduleComplex(a.x)+
		moduleComplex(a.y)*moduleComplex(a.y)+
		moduleComplex(a.z)*moduleComplex(a.z));
end;
